...
const AddMenu = () => {
  ...
  const staticMenus = [
    {
      ...
      price: 250,
      image: "https://www.tourmyindia.com/blog//wp-content/uploads/2017/06/Best-Places-for-Hardcore-Vegeterians-in-India.jpg",
    },
    {
      name: "Pasta Alfredo",
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    console.log("Static Data Submitted:", input);
  };
